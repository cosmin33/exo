package io.github.cosmin33.exo
...
object Conjunction:
  ...
  given productTypeclass[T[_], A, B](using L: LaxSemigroupal[/\, Function, /\, T], ab: T[A] /\ T[B]): T[A /\ B] =
    L.product(ab)
  ...
  extension[A, B, C] (p: A /\ (B /\ C))
    def tuple3: (A, B, C) = (p._1, p._2._1, p._2._2)

  extension[A, B, C, D] (p: A /\ (B /\ (C /\ D)))
    def tuple4: (A, B, C, D) = (p._1, p._2._1, p._2._2._1, p._2._2._2)

  extension[A, B, C, D, E] (p: A /\ (B /\ (C /\ (D /\ E))))
    def tuple5: (A, B, C, D, E) = (p._1, p._2._1, p._2._2._1, p._2._2._2._1, p._2._2._2._2)
