package io.github.cosmin33.exo.categories
...
trait MonoidalK[->[_,_], ⊙[_,_]] extends AssociativeK[->, ⊙]:
  ...
  def isoUnitorL[A[_]: TC]: ([a] =>> ⊙[Id[a], A[a]]) <-> A = IsoK.unsafe[->, [a] =>> ⊙[Id[a], A[a]], A](idl[A], coidl[A])(using C.lower)
  def isoUnitorR[A[_]: TC]: ([a] =>> ⊙[A[a], Id[a]]) <-> A = IsoK.unsafe[->, [a] =>> ⊙[A[a], Id[a]], A](idr[A], coidr[A])(using C.lower)
...
trait MonoidalK2[->[_,_], ⊙[_,_]] extends AssociativeK2[->, ⊙]:
  ...
  def isoUnitorL[A[_,_]: TC]: ([a, b] =>> ⊙[Id[a, b], A[a, b]]) <-> A = IsoK2.unsafe[->, [a, b] =>> ⊙[Id[a, b], A[a, b]], A](idl[A], coidl[A])(using C.lower)
  def isoUnitorR[A[_,_]: TC]: ([a, b] =>> ⊙[A[a, b], Id[a, b]]) <-> A = IsoK2.unsafe[->, [a, b] =>> ⊙[A[a, b], Id[a, b]], A](idr[A], coidr[A])(using C.lower)
...
trait MonoidalH[->[_,_], ⊙[_,_]] extends AssociativeH[->, ⊙]:
  ...
  def isoUnitorL[A[_[_]] : TC]: ([a[_]] =>> ⊙[Id[a], A[a]]) <-> A = IsoH.unsafe[->, [a[_]] =>> ⊙[Id[a], A[a]], A](idl[A], coidl[A])(using C.lower)
  def isoUnitorR[A[_[_]] : TC]: ([a[_]] =>> ⊙[A[a], Id[a]]) <-> A = IsoH.unsafe[->, [a[_]] =>> ⊙[A[a], Id[a]], A](idr[A], coidr[A])(using C.lower)
