...
trait LaxMonoidal[==>[_,_], ⊙=[_,_], -->[_,_], ⊙-[_,_], F[_]] extends LaxSemigroupal[==>, ⊙=, -->, ⊙-, F] { self =>
  type I1
  type I2
  def M1: Monoidal.Aux[==>, ⊙=, TC1, I1]
  def M2: Monoidal.Aux[-->, ⊙-, TC2, I2]
...
object LaxMonoidal {
  type Aux[==>[_,_], ⊙=[_,_], =>#[_], I10, -->[_,_], ⊙-[_,_], ->#[_], I20, F[_]] =
    LaxMonoidal[==>, ⊙=, -->, ⊙-, F] { type I1 = I10; type I2 = I20; type TC1[a] = =>#[a]; type TC2[a] = ->#[a] }
